            ...
            <aside className="ant-layout-sider">
              <Menu mode="inline" defaultSelectedKeys={['1']} defaultOpenKeys={['sub1']}>
                ...
                <SubMenu key="sub2" title={<span><Icon type="laptop" />导航二</span>}>
                  ...
                  <Menu.Item key="6"><Link to="/test6">Test6</Link></Menu.Item>
                  <Menu.Item key="7"><Link to="/test7">Test7</Link></Menu.Item>
                  <Menu.Item key="8"><Link to="/test8">Test8</Link></Menu.Item>
                </SubMenu>
              </Menu>
            </aside>
